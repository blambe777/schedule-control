/* Schedule Control Card - generated file; edit src/ instead. */
...
function rgbToHex(value = [255, 255, 255]) {
...
function validateBlocks(blocks = [], minimumMinutes = 15) {
...
function upsertBlock(blocks, block, originalIndex = -1, minimumMinutes = 15) {
  const next = [...(blocks || [])];
...
function replaceBlockRange(blocks, block, originalIndex = -1, minimumMinutes = 15) {
...
function copyDay(schedule, sourceDay, targetDays) {
...
function emptyWeek(name = "Schedule", icon = "mdi:calendar-clock") {
  return Object.fromEntries([["name", name], ["icon", icon], ...DAYS.map((day) => [day, []])]);
}

function focusBounds(center, windowMinutes = 360) {
...
function timelineMinuteToPercent(minute, mode = "overview", center = 720) {
...
function timelinePercentToMinute(percent, mode = "overview", center = 720) {
